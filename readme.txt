...
💰 **Sell Downloadable Products** – Sell Google Drive files through WooCommerce with secure delivery.

📦 **Google Drive Integration for Easy Digital Downloads** – Serve your digital downloads securely from Google Drive.  

📄 **Google Drive Integration for Download Manager** – Serve your digital files securely from Google Drive.
...
📄 **Google Drive File Uploader for Fluent Forms** – Receive Google Drive uploads from Fluent Forms file fields.
...
* Update: Refined user access control for improved permission handling.
* Update: Optimized media library file loading for faster performance.
* Update: Improved synchronization process for greater stability and consistency.

= 1.4.1 (01-04-2026) =
* Fixed: Shortcut file preview issue.
* Fixed: Folder icon design inconsistency.
* Fixed: File size display issue in Media Library.
* Fixed: File modified time showing identical timestamps for all items.
* Update: Improved design and full preview support for TXT files.
* Update: Removed file size for shortcut files and added dedicated shortcut icon.

= 1.4.0 (28-03-2026) =
* Update: Converted endpoints from Ajax to REST API.
* Update: Improved overall plugin performance and enhanced security.
* Update: File Manager is fully refreshed.
* Update: LightBox fully refreshed with new features.
* Fixed: Document loading issue.
* Fixed: Document download issue.
* Fixed: All unwanted notification issues are fixed.
* New: EDD integration added.
* New: Elementor Form upload support added.
* New: User Access and private folders support added.
* New: Ninja Forms integration added.
* New: Gravity Forms integration added.
* New: Formidable Forms integration added.
* New: Private folder support added in Module Builder.
* New: New features and settings added for the Gallery Module.
* New: New features and settings added for the File List Module.
* New: For more flexibility, added Delete, Upload, Create, Rename, and much more in Media Library.
