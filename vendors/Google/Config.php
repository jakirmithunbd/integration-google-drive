...
use CodeConfig\IGD\Google\Cache\CacheFile;
use CodeConfig\IGD\Google\IO\IOCurl;
use CodeConfig\IGD\Google\Logger\LoggerNull;
...
class Config
{
    ...
    /**
     * Create a new Config. Can accept an ini file location with the
    ...
    public function __construct($ini_file_location = null)
    {
        $this->configuration = [
            ...
            'application_name' => CCPIGD_NAME,

            // Which Authentication, Storage and HTTP IO classes to use.
            'auth_class'   => AuthOAuth2::class,
            'io_class'     => IOCurl::class,
            'cache_class'  => CacheFile::class,
            'logger_class' => LoggerNull::class,
     ...
     * the hd values within an id token (@see AuthLoginTicket) after sign
