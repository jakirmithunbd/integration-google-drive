...
namespace CodeConfig\IGD\Google\Task;
...
class TaskRunner
{
    ...
    /**
     * @var Client $client The current API client.
     */
    private $client;
    ...
    public function __construct(
        ...
        $config = (array) $client->getClassConfig('TaskRunner');
     ...
     *
     * @return mixed
     * @throws TaskRetryable on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
