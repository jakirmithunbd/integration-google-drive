...
namespace CodeConfig\IGD\Google\Service;

use CodeConfig\IGD\Google\Client;
use CodeConfig\IGD\Google\Collection;
use CodeConfig\IGD\Google\Http\HttpRequest;
use CodeConfig\IGD\Google\Model;
use CodeConfig\IGD\Google\Service;
 ...
 * @author Google, Inc.
 */
class ServiceDrive extends Service
{
    ...
    public function __construct(Client $client)
    {
        ...
        $this->about = new ServiceDriveAboutResource(
            $this,
            $this->serviceName,
            'about',
            [
        ...
        $this->changes = new ServiceDriveChangesResource(
            $this,
            $this->serviceName,
            'changes',
            [
        ...
        $this->channels = new ServiceDriveChannelsResource(
            $this,
            $this->serviceName,
            'channels',
            [
        ...
        $this->comments = new ServiceDriveCommentsResource(
            $this,
            $this->serviceName,
            'comments',
            [
        ...
        $this->files = new ServiceDriveFilesResource(
            $this,
            $this->serviceName,
            'files',
            [
        ...
        $this->permissions = new ServiceDrivePermissionsResource(
            $this,
            $this->serviceName,
            'permissions',
            [
        ...
        $this->replies = new ServiceDriveRepliesResource(
            $this,
            $this->serviceName,
            'replies',
            [
        ...
        $this->revisions = new ServiceDriveRevisionsResource(
            $this,
            $this->serviceName,
            'revisions',
            [
        ...
        $this->drives = new ServiceDriveDrivesResource(
            $this,
            $this->serviceName,
            'drives',
            [
 ...
 * Typical usage is:
 *  <code>
 *   $driveService = new ServiceDrive(...);
 *   $about = $driveService->about;
 *  </code>.
 */
class ServiceDriveAboutResource extends ServiceResource
{
    /**
    ...
    public function get($optParams = [])
    {
        ...
        return $this->call('get', [$params], ServiceDriveAbout::class);
    }
}
 ...
 *  </code>.
 */
class ServiceDriveChangesResource extends ServiceResource
{
    /**
     ...
     * @param array $optParams optional parameters
     *
     * @return ServiceDriveStartPageToken
     */
    public function getStartPageToken($optParams = [])
    {
        ...
        return $this->call('getStartPageToken', [$params], ServiceDriveStartPageToken::class);
    }
    ...
    public function listChanges($pageToken, $optParams = [])
    {
        ...
        return $this->call('list', [$params], ServiceDriveChangeList::class);
    }
     ...
     * user corpus. Supported values are 'drive', 'appDataFolder' and 'photos'.
     *
     * @return ServiceDriveChannel
     */
    public function watch($pageToken, ServiceDriveChannel $postBody, $optParams = [])
    {
        $params = ['pageToken' => $pageToken, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('watch', [$params], ServiceDriveChannel::class);
    }
}
 ...
 *  </code>.
 */
class ServiceDriveChannelsResource extends ServiceResource
{
    /**
     ...
     * @param array $optParams optional parameters
     */
    public function stop(ServiceDriveChannel $postBody, $optParams = [])
    {
 ...
 *  </code>.
 */
class ServiceDriveCommentsResource extends ServiceResource
{
    /**
     ...
     * @param array $optParams optional parameters
     *
     * @return ServiceDriveComment
     */
    public function create($fileId, ServiceDriveComment $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], ServiceDriveComment::class);
    }
    ...
    public function get($fileId, $commentId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], ServiceDriveComment::class);
    }
     ...
     *
     * @return ServiceDriveCommentList
     */
    public function listComments($fileId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], ServiceDriveCommentList::class);
    }
     ...
     * @return ServiceDriveComment
     */
    public function update($fileId, $commentId, ServiceDriveComment $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], ServiceDriveComment::class);
    }
}
 ...
 *  </code>.
 */
class ServiceDriveFilesResource extends ServiceResource
{
    /**
     ...
     *
     * @param string $fileId the ID of the file
     * @param ServiceDriveDriveFile $postBody
     * @param array $optParams optional parameters
     *
     ...
     *
     * @return HttpRequest|ServiceDriveDriveFile
     */
    public function copy($fileId, ServiceDriveDriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('copy', [$params], ServiceDriveDriveFile::class);
    }
     ...
     * @return HttpRequest|ServiceDriveDriveFile
     */
    public function create(ServiceDriveDriveFile $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], ServiceDriveDriveFile::class);
    }
     ...
     *
     * @return ServiceDriveGeneratedIds
     */
    public function generateIds($optParams = [])
    {
        ...
        return $this->call('generateIds', [$params], ServiceDriveGeneratedIds::class);
    }
    ...
    public function get($fileId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], ServiceDriveDriveFile::class);
    }
     ...
     *
     * @return HttpRequest|ServiceDriveFileList
     */
    public function listFiles($optParams = [])
    {
        ...
        return $this->call('list', [$params], ServiceDriveFileList::class);
    }
     ...
     * @return HttpRequest|ServiceDriveDriveFile
     */
    public function update($fileId, ServiceDriveDriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], ServiceDriveDriveFile::class);
    }
     ...
     * @return ServiceDriveChannel
     */
    public function watch($fileId, ServiceDriveChannel $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);
 ...
 *  </code>.
 */
class ServiceDrivePermissionsResource extends ServiceResource
{
    /**
     * Creates a permission for a file. (permissions.create).
     *
     * @param string $fileId the ID of the file
     * @param ServiceDrivePermission $postBody
     * @param array $optParams optional parameters
     *
     ...
     *
     * @return ServiceDrivePermission
     */
    public function create($fileId, ServiceDrivePermission $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], ServiceDrivePermission::class);
    }
    ...
    public function get($fileId, $permissionId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], ServiceDrivePermission::class);
    }
     ...
     * @param array $optParams optional parameters
     *
     * @return ServiceDrivePermissionList
     */
    public function listPermissions($fileId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], ServiceDrivePermissionList::class);
    }
     ...
     * @return ServiceDrivePermission
     */
    public function update($fileId, $permissionId, ServiceDrivePermission $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'permissionId' => $permissionId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], ServiceDrivePermission::class);
    }
}
 ...
 *  </code>.
 */
class ServiceDriveRepliesResource extends ServiceResource
{
    /**
     ...
     * @param array $optParams optional parameters
     *
     * @return ServiceDriveReply
     */
    public function create($fileId, $commentId, ServiceDriveReply $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], ServiceDriveReply::class);
    }
    ...
    public function get($fileId, $commentId, $replyId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], ServiceDriveReply::class);
    }
    ...
    public function listReplies($fileId, $commentId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], ServiceDriveReplyList::class);
    }
     ...
     * @return ServiceDriveReply
     */
    public function update($fileId, $commentId, $replyId, ServiceDriveReply $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], ServiceDriveReply::class);
    }
}
 ...
 *  </code>.
 */
class ServiceDriveRevisionsResource extends ServiceResource
{
    /**
    ...
    public function get($fileId, $revisionId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], ServiceDriveRevision::class);
    }
     ...
     * @param array $optParams optional parameters
     *
     * @return ServiceDriveRevisionList
     */
    public function listRevisions($fileId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], ServiceDriveRevisionList::class);
    }
     ...
     * @return ServiceDriveRevision
     */
    public function update($fileId, $revisionId, ServiceDriveRevision $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], ServiceDriveRevision::class);
    }
}

class ServiceDriveDrivesResource extends ServiceResource
{
    /**
     * @param array $optParams
     *
     * @return ServiceDriveDrive
     */
    public function create(ServiceDriveDrive $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], ServiceDriveDrive::class);
    }
    ...
    public function get($fileId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], ServiceDriveDriveList::class);
    }
    ...
    public function listDrives($optParams = [])
    {
        ...
        return $this->call('list', [$params], ServiceDriveDriveList::class);
    }
     ...
     * @return ServiceDriveDriveList
     */
    public function update($fileId, ServiceDriveDrive $postBody, $optParams = [])
    {
        $params = ['driveId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], ServiceDriveDriveList::class);
    }
}

class ServiceDriveAbout extends Collection
{
    public $appInstalled;
    ...
    protected $storageQuotaType     = ServiceDriveAboutStorageQuota::class;
    protected $storageQuotaDataType = '';
    protected $userType             = ServiceDriveUser::class;
    ...
    public function setStorageQuota(ServiceDriveAboutStorageQuota $storageQuota)
    {
    ...
    public function setUser(ServiceDriveUser $user)
    {
        $this->user = $user;
    }
...
class ServiceDriveAboutStorageQuota extends Model
{
    public $limit;
    public $usage;
    public $usageInDrive;
...
class ServiceDriveChange extends Model
{
    public $fileId;
    public $kind;
    public $removed;
    ...
    protected $fileType     = ServiceDriveDriveFile::class;
    ...
    public function setFile(ServiceDriveDriveFile $file)
    {
        $this->file = $file;
    }
    ...
    public function setDrive(ServiceDriveDrive $drive)
    {
        $this->drive = $drive;
    }
...
class ServiceDriveChangeList extends Collection
{
    public $kind;
    ...
    protected $changesType     = ServiceDriveChange::class;
...
class ServiceDriveChannel extends Model
{
    public $address;
    public $expiration;
    public $id;
...
class ServiceDriveComment extends Collection
{
    public $anchor;
    public $content;
    public $createdTime;
    ...
    protected $authorType                = ServiceDriveUser::class;
    protected $authorDataType            = '';
    protected $quotedFileContentType     = ServiceDriveCommentQuotedFileContent::class;
    protected $quotedFileContentDataType = '';
    protected $repliesType               = ServiceDriveReply::class;
    ...
    public function setAuthor(ServiceDriveUser $author)
    {
        $this->author = $author;
    }
    ...
    public function setQuotedFileContent(ServiceDriveCommentQuotedFileContent $quotedFileContent)
    {
...
class ServiceDriveCommentList extends Collection
{
    public $kind;
    public $nextPageToken;
    ...
    protected $commentsType     = ServiceDriveComment::class;
...
class ServiceDriveCommentQuotedFileContent extends Model
{
    public $mimeType;
    public $value;
    protected $internal_gapi_mappings = [
...
class ServiceDriveDriveFile extends Collection
{
    ...
    protected $capabilitiesType           = ServiceDriveDriveFileCapabilities::class;
    protected $capabilitiesDataType       = '';
    protected $contentHintsType           = ServiceDriveDriveFileContentHints::class;
    protected $contentHintsDataType       = '';
    protected $imageMediaMetadataType     = ServiceDriveDriveFileImageMediaMetadata::class;
    protected $imageMediaMetadataDataType = '';
    protected $lastModifyingUserType      = ServiceDriveUser::class;
    protected $lastModifyingUserDataType  = '';
    protected $ownersType                 = ServiceDriveUser::class;
    protected $ownersDataType             = 'array';
    protected $permissionsType            = ServiceDrivePermission::class;
    protected $permissionsDataType        = 'array';
    protected $sharingUserType            = ServiceDriveUser::class;
    protected $sharingUserDataType        = '';
    protected $videoMediaMetadataType     = ServiceDriveDriveFileVideoMediaMetadata::class;
    protected $videoMediaMetadataDataType = '';
    protected $shortcutDetailsType        = ServiceDriveDriveFileShortcutDetails::class;
    ...
    public function setCapabilities(ServiceDriveDriveFileCapabilities $capabilities)
    {
    ...
    public function setContentHints(ServiceDriveDriveFileContentHints $contentHints)
    {
    ...
    public function setImageMediaMetadata(ServiceDriveDriveFileImageMediaMetadata $imageMediaMetadata)
    {
    ...
    public function setLastModifyingUser(ServiceDriveUser $lastModifyingUser)
    {
    ...
    public function setSharingUser(ServiceDriveUser $sharingUser)
    {
    ...
    public function setVideoMediaMetadata(ServiceDriveDriveFileVideoMediaMetadata $videoMediaMetadata)
    {
    ...
    public function setShortcutDetails(ServiceDriveDriveFileShortcutDetails $shortcutDetails)
    {
...
class ServiceDriveDriveFileCapabilities extends Model
{
...
class ServiceDriveDriveFileContentHints extends Model
{
    public $indexableText;
    protected $internal_gapi_mappings = [
    ];
    protected $thumbnailType     = ServiceDriveDriveFileContentHintsThumbnail::class;
    ...
    public function setThumbnail(ServiceDriveDriveFileContentHintsThumbnail $thumbnail)
    {
...
class ServiceDriveDriveFileContentHintsThumbnail extends Model
{
    public $image;
    public $mimeType;
    protected $internal_gapi_mappings = [
...
class ServiceDriveDriveFileImageMediaMetadata extends Model
{
    public $aperture;
    public $cameraMake;
    public $cameraModel;
    ...
    protected $locationType     = ServiceDriveDriveFileImageMediaMetadataLocation::class;
    ...
    public function setLocation(ServiceDriveDriveFileImageMediaMetadataLocation $location)
    {
...
class ServiceDriveDriveFileImageMediaMetadataLocation extends Model
{
    public $altitude;
    public $latitude;
    public $longitude;
...
class ServiceDriveDriveFileVideoMediaMetadata extends Model
{
...
class ServiceDriveDriveFileShortcutDetails extends Model
{
    public $targetId;
...
class ServiceDriveFileList extends Collection
{
    public $kind;
    public $nextPageToken;
    ...
    protected $filesType     = ServiceDriveDriveFile::class;
...
class ServiceDriveGeneratedIds extends Collection
{
    public $ids;
    public $kind;
    public $space;
...
class ServiceDrivePermission extends Model
{
...
class ServiceDrivePermissionList extends Collection
{
    public $kind;
    public $nextPageToken;
...
class ServiceDriveReply extends Model
{
    public $action;
    public $content;
    public $createdTime;
...
class ServiceDriveReplyList extends Collection
{
    public $kind;
    public $nextPageToken;
    protected $collection_key         = 'replies';
...
class ServiceDriveRevision extends Model
{
    public $id;
    public $keepForever;
    public $kind;
...
class ServiceDriveRevisionList extends Collection
{
    public $kind;
    protected $collection_key         = 'revisions';
    protected $internal_gapi_mappings = [
    ];
    protected $revisionsType     = ServiceDriveRevision::class;
...
class ServiceDriveStartPageToken extends Model
{
    public $kind;
...
class ServiceDriveUser extends Model
{
    public $displayName;
    public $emailAddress;
    public $kind;
...
class ServiceDriveDrive extends Model
{
    ...
    public $name;
    public $themeId;
    protected $backgroundImageFileType     = ServiceDriveDriveBackgroundImageFile::class;
    protected $backgroundImageFileDataType = '';
    protected $capabilitiesType            = ServiceDriveDriveCapabilities::class;
    protected $capabilitiesDataType        = '';

    public function getCreatedTime()
    {
        if (!isset($this->modelData['createdTime'])) {
            return new \DateTime();
        }

        return new \DateTime($this->modelData['createdTime']);
    }

    /**
     * @param ServiceDriveDriveBackgroundImageFile
     */
    public function setBackgroundImageFile(ServiceDriveDriveBackgroundImageFile $backgroundImageFile)
    {
        $this->backgroundImageFile = $backgroundImageFile;
    }

    /**
     * @return ServiceDriveDriveBackgroundImageFile
     */
    ...
    /**
     * @param ServiceDriveDriveCapabilities
     */
    public function setCapabilities(ServiceDriveDriveCapabilities $capabilities)
    {
        $this->capabilities = $capabilities;
    }

    /**
     * @return ServiceDriveDriveCapabilities
     */
    public function getCapabilities()
    {
        return $this->capabilities;
...
class ServiceDriveDriveCapabilities extends Model
{
    public $canAddChildren;
...
class ServiceDriveDriveBackgroundImageFile extends Model
{
    public $id;
    public $width;
    public $xCoordinate;
...
class ServiceDriveDriveList extends Collection
{
    public $kind;
    public $nextPageToken;
    protected $collection_key = 'drives';
    protected $drivesType     = ServiceDriveDrive::class;
